...
export const previewCitizenImport = async (file: File) => { const form = new FormData(); form.append("file", file); return unwrap<ImportPreview>(await axiosInstance.post("/citizens/import/preview", form, { headers: { "Content-Type": "multipart/form-data" } })); };
